...
path_exp_root=logs_final/EGOME-action-anticipation-noun-szf-egoonly-ep200/ # depend on users
...
###
train_source_list=$path_data_root"Annotation_train_Ego_noun.txt"
train_target_list=$path_data_root"Annotation_train_Ego_noun.txt"
# val_list=$path_data_root"Annotation_val_Ego_noun.txt"
# test_list=$path_data_root"Annotation_test_Ego_noun.txt"
val_list=$path_data_root"Annotation_val_Exo_noun.txt"
test_list=$path_data_root"Annotation_test_Exo_noun.txt"
NUM_CLASSES=35
