...
#====== select dataset ======#
path_data_root=anticpation_annotation_egome/verb/ # depend on users
path_exp_root=logs_final/EGOME-action-anticipation-verb-szf-egoonly-ep200/ # depend on users
...
dataset_target=ego # depend on users
dataset_val=ego  # depend on users
dataset_test=ego # depend on users
num_source=8939 # number of training data (source)
num_target=8939 # number of training data (target)


train_source_list=$path_data_root"Annotation_train_Ego_verb.txt"
train_target_list=$path_data_root"Annotation_train_Ego_verb.txt"
val_list=$path_data_root"Annotation_val_Exo_verb.txt"
test_list=$path_data_root"Annotation_test_Exo_verb.txt"
NUM_CLASSES=29
