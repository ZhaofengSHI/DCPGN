...
#====== select dataset ======#
path_data_root=anticpation_annotation_egome/anticpation_annotation_egome/verb/ # depend on users
path_exp_root=logs_final/EGOME-action-anticipation-verb-szf-exoonly-ep200/ # depend on users
...
train_source_list=$path_data_root"Annotation_train_Exo_verb.txt"
train_target_list=$path_data_root"Annotation_train_Exo_verb.txt"
