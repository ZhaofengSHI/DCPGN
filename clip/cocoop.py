...
class CoCoOpCLIP(nn.Module):
    ...
    def inference(self, image_features, label=None):
        ...
        image_features = image_features.view(n*l ,c )
        ...
        ######
        logits = logits.view(n,l,logits.shape[-1])
