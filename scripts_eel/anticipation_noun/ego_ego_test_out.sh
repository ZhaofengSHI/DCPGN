...
#====== select dataset ======#
path_data_root=anticpation_annotation_eel/noun/ # depend on users
path_exp_root=logs_final/EEL-action-anticipation-noun-szf-egoonly/ # depend on users
...
num_source=78055 # number of training data (source)
num_target=78055 # number of training data (target)
