...
test_log_name='test_results_out.txt'
...
#====== select dataset ======#
path_data_root=/data1/zhaofeng/TTA/EEL-benchmark-features-szf/EEL-annotations/anticpation_annotation_eel_filtered/noun/ # depend on users
path_exp_root=logs_final/EEL-action-anticipation-noun-szf-exoonly/ # depend on users
# path_feat_root=/data1/zhaofeng/TTA/EEL-benchmark-features-szf/EEL-features-C/clip_features_5fps_unzip/ # depend on users
path_feat_root=/data1/zhaofeng/TTA/EEL-benchmark-features-szf/EEL-our-extraction/EEL-features-our-extract/EEL-clipl_features_5fps_szf_extracted-pt/ # depend on users
...
num_source=11762 # number of training data (source)
num_target=11762 # number of training data (target)
...
then
	...
	-j 4 --bS 512 --top 1 3 5 --add_fc $add_fc --fc_dim $fc_dim --baseline_type $baseline_type --frame_aggregation $frame_aggregation  --num_classes $NUM_CLASSES \
