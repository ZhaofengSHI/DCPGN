...
category_txt='anticpation_annotation_eel/noun_vocabulary_final.txt'
...
test_list='anticpation_annotation_eel/noun_addtext_final/list_exo_test_ego_exo-feature.txt'
NUM_CLASSES=31
####
