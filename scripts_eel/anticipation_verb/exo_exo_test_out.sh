...
path_exp_root=logs_final/EEL-action-anticipation-verb-szf-exoonly/ # depend on users
...
num_source=17516 # number of training data (source)
num_target=17516 # number of training data (target)
