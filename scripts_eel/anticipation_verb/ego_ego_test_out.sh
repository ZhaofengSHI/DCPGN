...
#====== select dataset ======#
path_data_root=anticpation_annotation_eel/verb/ # depend on users
path_exp_root=logs_final/EEL-action-anticipation-verb-szf-egoonly/ # depend on users
path_feat_root=/data1/zhaofeng/TTA/anti-TTA/DCPGN-release/EEL-benchmark/EEL_final_features/EEL-features-our-extract/EEL-clipl_features_5fps_szf_extracted-pt/ # depend on users
...
num_source=33496 # number of training data (source)
num_target=33496 # number of training data (target)
