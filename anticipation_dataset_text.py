...
class TSNDataSet(data.Dataset):
    ...
    def get_anti_item(self, index):
        ...
        # 文本
        # print(record.text)
        text_token = torch.squeeze(clip_tokenizer.tokenize(record.text,truncate=True))


        return sample_feature, one_hot_labels, text_token
